...
public class EnrichmentChamberMenu extends AbstractContainerMenu {
	public final EnrichmentChamberBlockEntity blockEntity;
	...
	public EnrichmentChamberMenu(int id, Inventory inv, FriendlyByteBuf buf) {
	    this(id, inv, (EnrichmentChamberBlockEntity) inv.player.level().getBlockEntity(buf.readBlockPos()),
	         new SimpleContainerData(3));
	}

	public EnrichmentChamberMenu(int id, Inventory inv, EnrichmentChamberBlockEntity be, ContainerData data) {
	    ...
	    this.addSlot(new SlotItemHandler(be.itemHandler, 2, 127, 38) {
	        @Override public boolean mayPlace(ItemStack stack) { return false; }
	    });
